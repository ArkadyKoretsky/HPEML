...
Memory_Block<scalar, T>::Memory_Block() : _row(0), _col(0), _mat(nullptr) {}
template<typename scalar, typename T>
Memory_Block<scalar, T>::Memory_Block(size_t row, size_t col) : _row(row), _col(col), _mat(new scalar[row * col]) {}
template<typename scalar, typename T>
